...
var update = __webpack_require__(24)("2a854ff6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5a822672\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5a822672\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(24)("5e8d4291", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5a822672\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./manage.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5a822672\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./manage.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    load_company_privileges: function load_company_privileges() {
      var _this2 = this;
      ...
      axios.get(this.$store.state.host_url + "/company_permissions?" + params, {
        ...
        response.data.data.forEach(function (item) {
          _this2.available_privileges.push(item.permission);
        });
      }).catch(function (error) {
        __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
        __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("catch_errors", error);
    ...
    show_company_roles: function show_company_roles(company_id) {
      var _this3 = this;
      ...
      axios.get(this.$store.state.host_url + "/roles/by_company/" + company_id, {
        ...
        _this3.load_company_privileges();
        _this3.tableData.forEach(function (item, index) {
          var perm = '';
          _this3.tableData[index]['selected_privileges'] = [];
          item.role_permissions.forEach(function (inner_item) {
            if (inner_item.permission !== undefined) {
              ...
              _this3.tableData[index]['selected_privileges'].push(element);

              _this3.tableData[index]['permissions'] = perm;
              _this3.tableData[index]['tabledata_index'] = index;
            }
          });
        });
      }).catch(function (error) {
    ...
    add_company_roles: function add_company_roles() {
      var _this6 = this;
        ...
        if (this.role.submit_mode == 'CREATE') {
          axios.post(this.url, role_detail, {
            ...
            if (api_response.status === true) {
              ...
              _this6.role = { submit_mode: "CREATE" };
            }
          }).catch(function (error) {
            __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
            __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("catch_errors", error);
                    ...
                    "vue-form",
                    {
                      ...
                      on: {
                        submit: function($event) {
                          ...
                          return _vm.add_company_roles($event)
                        }
                      }
                    },
                    [
                          ...
                          [
                            ...
                            _c("div", { staticClass: "col-sm-12" }, [
                              _c(
                                ...
                                { staticClass: "form-group" },
                                [
                                  _vm.available_privileges.length
                                    ? _c(
                                        "b-card",
                                        {
                                          staticClass: "bg-info-card",
                                          attrs: {
                                            header: "Available Privileges",
                                            "header-tag": "h4"
                                          }
                                        },
                                        [
                              ...
                              _c(
                                ...
                                [
                                  _c("input", {
                                    ...
                                    attrs: { type: "submit" },
                                    domProps: { value: _vm.role.submit_mode }
                                  })
                                ]
                              )
                            ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5a822672", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/roles/manage.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5a822672", Component.options)
  } else {
    hotAPI.reload("data-v-5a822672", Component.options)
  }
