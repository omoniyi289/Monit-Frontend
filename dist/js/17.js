...
var update = __webpack_require__(92)("2a854ff6", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("5e8d4291", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vue_multiselect__ = __webpack_require__(829);
    ...
    deleteItem: function deleteItem(data) {
      ...
      axios.delete(this.url + '/' + data.id, {
        ...
        if (company_response.status === true) {
          ...
          _this5.$alert.success({ duration: 5000, forceRender: '',
        ...
        if (this.role.submit_mode == 'CREATE') {
          ...
          axios.patch(this.url + "/" + this.role.id, role_detail, {
            ...
            if (company_response.status === true) {
              ...
              _this6.$alert.success({ duration: 5000, forceRender: '',
