...
var update = __webpack_require__(24)("39067e58", content, false, {});
        ...
        onSubmit: function onSubmit() {
            ...
            if (this.formstate.$invalid) {
                ...
                axios.post(host_url + '/auth/forgotpass/verifyemail', { 'email': this.model.email }, {
                    ...
                    _this.login_submit = "Send Confirmation Mail";
                    _this.success_message = "Confirmation successful, an email has been sent to you with further instructions";
