...
var update = __webpack_require__(24)("4a4df264", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3df9d396\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./close-station.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3df9d396\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./close-station.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_components_plugins_Company_Station_View_CSView_vue__ = __webpack_require__(310);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_src_validations_validations_js__ = __webpack_require__(303);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__ = __webpack_require__(25);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    show_company_stations: function show_company_stations(company_name) {
      ...
      __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "start");
      ...
      axios.get(this.$store.state.host_url + "/stations/by_company/" + company_name, {
        ...
        __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
        _this.company_stations = response.data.data;
      }).catch(function (error) {
        __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
        __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("catch_errors", error);
      });
    },
    show_open_station_info: function show_open_station_info(station_id, company_id) {
      ...
      if (this.formstate2.$invalid) {
        ...
        var user_details = JSON.parse(localStorage.getItem('user_details'));
        var params = 'station_id=' + this.preset.station_id + '&get_station_last_readings=1';
        axios.get(this.$store.state.host_url + "/stock-readings/by_station?" + params, {
          ...
          if (stock_response.data.data.length == 0) {
            __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
            __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("showAlertBox", { 'alert_type': 'alert-danger',
            ...
            if (stock_response.data.data[0]['phy_shift_end_volume_reading'] != null) {
              ...
              _this2.set_date = stock_response.data.data[0].reading_date;

              _this2.station_tanks = stock_response.data.data;
              _this2.close_tank_reading = [];
              _this2.station_tanks.forEach(function (element) {
                var _this2$close_tank_rea;

                _this2.close_tank_reading.push((_this2$close_tank_rea = { 'tank_code': element.tank_code, 'tank_id': element.tank_id,
                  'opening_reading': element.phy_shift_start_volume_reading }, _defineProperty(_this2$close_tank_rea, "tank_id", element.tank_id), _defineProperty(_this2$close_tank_rea, 'closing_reading', ''), _defineProperty(_this2$close_tank_rea, 'c_closing_reading', ''), _defineProperty(_this2$close_tank_rea, 'rtt', ''), _defineProperty(_this2$close_tank_rea, 'qty_recieved', ''), _defineProperty(_this2$close_tank_rea, 'c_rtt', ''), _defineProperty(_this2$close_tank_rea, 'c_qty_recieved', ''), _defineProperty(_this2$close_tank_rea, 'status', 'Closed'), _this2$close_tank_rea));
              });

              ///pumps//
              var _params = 'station_id=' + _this2.preset.station_id + '&get_station_last_readings=1';;
              axios.get(_this2.$store.state.host_url + "/pump-readings/by_station?" + _params, {
                headers: {
                  "Authorization": "Bearer " + user_details.token, "Cache-Control": "no-cache"
                } }).then(function (pump_response) {
                __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
                _this2.station_pumps = pump_response.data.data;
                _this2.close_pump_reading = [];
                _this2.station_pumps.forEach(function (element) {

                  var pump_split_array = element.nozzle_code.split(" ");
                  var number = parseInt(pump_split_array[pump_split_array.length - 1]);

                  if (element.shift_2_totalizer_reading != null) {
                    _this2.close_pump_reading.push({ 'pump_id': element.pump_id,
                ...
                _this2.close_pump_reading.sort(function (a, b) {
    ...
    show_available_companies: function show_available_companies() {
      this.products = __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].state.products;
      if (__WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].state.show_single_company) {
        this.available_company = __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].state.available_company;
        this.show_single_company = __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].state.show_single_company;
      } else if (__WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].state.show_multi_company == true) {
        this.available_companies = __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].state.available_companies;
        this.show_multi_company = __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].state.show_multi_company;
      }
    },
    ...
    onSubmit: function onSubmit() {
      ...
      if (this.formstate.$invalid) {
        ...
        return;
      } else if (this.close_pump_reading == 0) {
        __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("showAlertBox", { 'alert_type': 'alert-danger',
          'alert_message': 'input error, No pump readings supplied', 'show_alert': true });
        return;
      } else if (this.close_tank_reading == 0) {
        __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("showAlertBox", { 'alert_type': 'alert-danger',
          'alert_message': 'input error, No tank readings supplied', 'show_alert': true });
        return;
      } else {
        __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "start");
        __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("showPermAlertBox", { 'alert_type': 'alert-warning',
          'alert_message': '...Processing Request...', 'show_alert': true });
        var pump_invalid_monitor = false;
        var tank_invalid_monitor = false;
        this.close_pump_reading.forEach(function (element) {
        ...
        axios.patch(this.$store.state.host_url + "/stock-readings", { 'stocks': this.final_stock_info }, {
          ...
          __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
          axios.patch(_this3.$store.state.host_url + "/pump-readings", { 'pumps': _this3.final_pump_info }, {
            headers: {
              "Authorization": "Bearer " + user_details.token, "Cache-Control": "no-cache"
            }
          }).then(function (response) {
            ...
            if (api_response.status === true) {
              __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("showAlertBox", { 'alert_type': 'alert-success',
                'alert_message': 'Readings Updated Successfully', 'show_alert': true });
              _this3.formstate.$submitted = false;
              _this3.close_pump_reading = {};
              _this3.close_tank_reading = {};
              __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
            }
          }).catch(function (error) {
            __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
  ...
  mounted: function mounted() {
    __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("check_login_details");
                ...
                [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("b", [
                        _vm._v("Reading Date : " + _vm._s(this.set_date))
                      ]),
                      _vm._v(" "),
                      _c(
                        "b-card",
                              ...
                              [
                                _c(
                                  ...
                                  [
                                    _c(
                                      "b-tab",
                                      { attrs: { title: "Stock Readings" } },
                                      [
                                        _c("table", { staticClass: "table" }, [
                                          _c("thead", [
                                            _c("tr", [
                                              _c("th", [_vm._v("Tank Code")]),
                                              _vm._v(" "),
                                              _c("th", [
                                                _vm._v("Opening Volume Reading")
                                              ]),
                                              _vm._v(" "),
                                              _c("th", [
                                                _vm._v("Quantity Received")
                                              ]),
                                              _vm._v(" "),
                                              _c("th", [
                                                _vm._v("Return to Tank")
                                              ]),
                                              _vm._v(" "),
                                              _c("th"),
                                              _vm._v(" "),
                                              _c("th", [_vm._v("GIT Loss")]),
                                              _vm._v(" "),
                                              _c("th", [
                                                _vm._v("Closing Volume Reading")
                                              ])
                                            ])
                                          ]),
                                          _vm._v(" "),
                                          _c(
                                            "tbody",
                                            _vm._l(
                                              _vm.close_tank_reading,
                                              function(option, index) {
                                                return _c("tr", [
                                                  _c("th", [
                                                    _vm._v(
                                                      _vm._s(option.tank_code)
                                                    )
                                                  ]),
                                                  _vm._v(" "),
                                                  _c("td", [
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  _vm
                                                                    ...
                                                                    .qty_received,
                                                                expression:
                                                                  "close_tank_reading[index].qty_received"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  _vm
                                                                    ...
                                                                    .c_qty_received,
                                                                expression:
                                                                  "close_tank_reading[index].c_qty_received"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                          ...
                                                          _c(
                                                            ...
                                                            [
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "Confirm Quantity Recieved is required"
                                                                  )
                                                                ]
                                                              ),
                                                              _vm._v(" "),
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "Quantity Recieved should match"
                                                                  )
                                                                ]
                                                              )
                                                            ]
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                expression:
                                                                  "close_tank_reading[index].c_rtt"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                expression:
                                                                  "close_tank_reading[index].c_git_loss"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  _vm
                                                                    ...
                                                                    .closing_reading,
                                                                expression:
                                                                  "close_tank_reading[index].closing_reading"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  _vm
                                                                    ...
                                                                    .c_closing_reading,
                                                                expression:
                                                                  "close_tank_reading[index].c_closing_reading"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                          ...
                                                          _c(
                                                            ...
                                                            [
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "Confirm Closing Reading is required"
                                                                  )
                                                                ]
                                                              ),
                                                              _vm._v(" "),
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "Closing and Confirm Closing Reading should match"
                                                                  )
                                                                ]
                                                              )
                                                            ]
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  _vm
                                                                    ...
                                                                    .closing_reading,
                                                                expression:
                                                                  "close_pump_reading[index].closing_reading"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  _vm
                                                                    ...
                                                                    .c_closing_reading,
                                                                expression:
                                                                  "close_pump_reading[index].c_closing_reading"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                      ...
                                                      directives: [
                                                        {
                                                          ...
                                                          expression:
                                                            "close_pump_reading[index].closing_reading-close_pump_reading[index].opening_reading"
                                                        }
                                                      ],
                                                      staticClass:
                                                        "form-control",
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  _vm
                                                                    ...
                                                                    .c_cash_collected,
                                                                expression:
                                                                  "close_pump_reading[index].c_cash_collected"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                          ...
                                                          _c(
                                                            ...
                                                            [
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "Confirm Cash Collected is required"
                                                                  )
                                                                ]
                                                              ),
                                                              _vm._v(" "),
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "Cash and Confirm  Collected should match"
                                                                  )
                                                                ]
                                                              )
                                                            ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3df9d396", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/ss-management/close-station.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3df9d396", Component.options)
  } else {
    hotAPI.reload("data-v-3df9d396", Component.options)
  }
