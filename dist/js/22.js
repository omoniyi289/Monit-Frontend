...
var update = __webpack_require__(24)("4cbde58e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-57eff242\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-57eff242\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(24)("74cb27b3", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-57eff242\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./stock-refill.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-57eff242\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./stock-refill.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
  ...
  methods: {
    show_company_stations: function show_company_stations(company_name) {
      ...
      axios.get(this.$store.state.host_url + "/stations/by_company/" + company_name, {
        ...
        ///get roles///
        axios.get(_this.$store.state.host_url + "/roles/by_company/" + company_name, {
          headers: {
            "Authorization": "Bearer " + user_details.token
          } }).then(function (response) {
        ...
        ///get users
        axios.get(_this.$store.state.host_url + "/company_users/by_company/" + company_name, {
          headers: {
            "Authorization": "Bearer " + user_details.token
          } }).then(function (response) {
    ...
    show_notification_modules: function show_notification_modules() {
      ...
      axios.get(this.$store.state.host_url + "/notifications", {
        ...
        //
        _this2.company_notifications = response.data.data;
      });
    },
                              ...
                              _c(
                                ...
                                [
                                  _vm.company_stations.length
                                    ...
                                    : _c("p", [
                                        _vm._v(
                                          _vm._s(this.company_stations_null)
                                        )
                                      ])
                                ],
                                1
                                ...
                                [
                                  _vm.company_notifications.length
                                    ...
                                    : _c("p", [
                                        _vm._v(
                                          _vm._s(
                                            this.company_notifications_null
                                          )
                                        )
                                      ])
                                ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-57eff242", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/store-management/stock-refill.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-57eff242", Component.options)
  } else {
    hotAPI.reload("data-v-57eff242", Component.options)
  }
