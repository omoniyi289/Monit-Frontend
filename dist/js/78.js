...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_src_store_store_js__ = __webpack_require__(93);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        do_verify: function do_verify() {
            ...
            axios.get(host_url + '/users/vefify/' + this.$route.params.token).then(function (response) {
