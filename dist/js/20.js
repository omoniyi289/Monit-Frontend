...
var update = __webpack_require__(92)("649f17d1", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_src_validations_validations_js__ = __webpack_require__(795);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_src_assets_json_states_json__ = __webpack_require__(968);
        ...
        deleteItem: function deleteItem(data) {
            ...
            axios.delete(this.url + '/' + data.id, {
                ...
                if (company_response.status === true) {
                    ...
                    _this3.$alert.success({ duration: 5000, forceRender: '',
                ...
                if (this.station.submit_mode == 'CREATE') {
                    axios.post(this.url, station_detail, {
                        ...
                        if (station_response.status === true) {
                            ...
                            _this4.$alert.success({ duration: 5000, forceRender: '',
