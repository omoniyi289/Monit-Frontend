...
var update = __webpack_require__(24)("140cce6c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-35ba0c8f\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./receive.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-35ba0c8f\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./receive.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return { columndata: [{
      ...
      is_code_valid: false,
      added_product_name: "",
      statuses: ['Pending', 'Approved', 'Rejected', 'Order in Process', 'Goods in Transit', 'Arrived at Destintation', 'Delivery Completed'],
  ...
  methods: {
    ...
    onSubmit: function onSubmit() {
      ...
      if (this.formstate.$invalid) {
        ...
        axios.post(this.url, fuel_supply_detail, {
          ...
          _this3.tableData.forEach(function (element) {
            if (_this3.fuel_supply.request_code == element.request_code) {
              axios.get(_this3.url + '/print-delivery-pdf?id=' + element.id, { responseType: 'blob' }).then(function (response) {
    ...
    check_request_code: function check_request_code(code) {
      var _this4 = this;
      ...
      this.show_setup_form = true;
      var user_details = JSON.parse(localStorage.getItem('user_details'));
      var params = 'code=' + code + '&company_id=' + this.preset.company_id + '&station_id=' + this.preset.station_id;
      axios.get(this.$store.state.host_url + "/fuel-supply/by_request_code/params?" + params, {
        headers: {
          "Authorization": "Bearer " + user_details.token, "Cache-Control": "no-cache"
        } }).then(function (response) {
        __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
        _this4.is_code_valid = true;
        _this4.fuel_supply.quantity_requested = response.data.data.stock_received.quantity_requested;
        _this4.fuel_supply.created_at = response.data.data.stock_received.created_at;
        _this4.fuel_supply.quantity_loaded = response.data.data.stock_received.quantity_loaded;
        _this4.fuel_supply.driver_name = response.data.data.stock_received.driver_name;
        _this4.fuel_supply.truck_departure_time = response.data.data.stock_received.truck_departure_time;
        _this4.fuel_supply.truck_reg_number = response.data.data.stock_received.truck_reg_number;
        _this4.fuel_supply.waybill_number = response.data.data.stock_received.waybill_number;
      }).catch(function (error) {
        __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
        __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("catch_errors", error);
      });
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    {
                      staticClass: "bg-info-card",
                      attrs: { header: "Receive Stock", "header-tag": "h5" }
                    },
                    [
                      _c(
                        "vue-form",
                                ...
                                [
                                  _c(
                                    "span",
                                    {
                                      ...
                                      on: {
                                        click: function($event) {
                                          _vm.check_request_code(
                                            _vm.fuel_supply.request_code
                                          )
                                        }
                                      }
                                    },
                                ...
                                directives: [
                                  {
                                    name: "show",
                                    rawName: "v-show",
                                    value: _vm.is_code_valid,
                                    expression: "is_code_valid"
                                  }
                                ]
                              },
                              [
                                _c("div", { staticClass: "col-sm-12" }, [
                                      ...
                                      directives: [
                                        {
                                          name: "model",
                                          rawName: "v-model",
                                          value: _vm.fuel_supply.created_at,
                                          expression: "fuel_supply.created_at"
                                        }
                                      ],
                                      staticClass: "form-control",
                                      attrs: {
                                      ...
                                      directives: [
                                        {
                                          name: "model",
                                          rawName: "v-model",
                                          value: _vm.fuel_supply.waybill_number,
                                          expression:
                                            "fuel_supply.waybill_number"
                                        }
                                      ],
                                      staticClass: "form-control",
                                      attrs: {
                                  ...
                                  _c("div", { staticClass: "form-group" }, [
                                    ...
                                    _c("input", {
                                      directives: [
                                        {
                                          ...
                                          value:
                                            _vm.fuel_supply
                                              .truck_departure_time,
                                          expression:
                                            "fuel_supply.truck_departure_time"
                                        }
                                      ],
                                      staticClass: "form-control",
                                      attrs: {
                                        name: "truck_departure_time",
                                        type: "text",
                                        autofocus: "",
                                        readonly: ""
                                      },
                                      domProps: {
                                        value:
                                          _vm.fuel_supply.truck_departure_time
                                      },
                                      on: {
                                        input: function($event) {
                                          if ($event.target.composing) {
                                          ...
                                          _c(
                                            ...
                                            [
                                              _c(
                                                ...
                                                [
                                                  _vm._v(
                                                    "Quantity Supplied is a required field"
                                                  )
                                                ]
                                              )
                                            ]
                                            ...
                                            directives: [
                                              {
                                                ...
                                                rawName: "v-model",
                                                value:
                                                  _vm.fuel_supply.arrival_time,
                                                expression:
                                                  "fuel_supply.arrival_time"
                                              }
                                            ],
                                            staticClass: "form-control",
                                            attrs: {
                                          ...
                                          _c(
                                            ...
                                            [
                                              _c(
                                                ...
                                                [
                                                  _vm._v(
                                                    "Arrival Time is a required field"
                                                  )
                                                ]
                                              )
                                            ]
                                            ...
                                            directives: [
                                              {
                                                ...
                                                value:
                                                  _vm.fuel_supply
                                                    .quantity_before_discharge,
                                                expression:
                                                  "fuel_supply.quantity_before_discharge"
                                              }
                                            ],
                                            staticClass: "form-control",
                                            attrs: {
                                              name: "quantity_before_discharge",
                                              type: "text",
                                              required: "",
                                              autofocus: "",
                                              placeholder:
                                                "Tank Vol before Discharge",
                                              id: "quantity_before_discharge"
                                            },
                                            domProps: {
                                              value:
                                                _vm.fuel_supply
                                          ...
                                          _c(
                                            ...
                                            [
                                              _c(
                                                ...
                                                [
                                                  _vm._v(
                                                    "Tank Volume before Discharge is a required field"
                                                  )
                                                ]
                                              )
                                            ]
                                            ...
                                            directives: [
                                              {
                                                ...
                                                value:
                                                  _vm.fuel_supply
                                                    .quantity_after_discharge,
                                                expression:
                                                  "fuel_supply.quantity_after_discharge"
                                              }
                                            ],
                                            staticClass: "form-control",
                                            attrs: {
                                              name: "quantity_after_discharge",
                                              type: "text",
                                              required: "",
                                              autofocus: "",
                                              placeholder:
                                                "Tank Vol after Discharge",
                                              id: "quantity_after_discharge"
                                            },
                                            domProps: {
                                              value:
                                                _vm.fuel_supply
                                          ...
                                          _c(
                                            ...
                                            [
                                              _c(
                                                ...
                                                [
                                                  _vm._v(
                                                    "Tank Volume after Discharge is a required field"
                                                  )
                                                ]
                                              )
                                            ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-35ba0c8f", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/fuel-supply/receive.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-35ba0c8f", Component.options)
  } else {
    hotAPI.reload("data-v-35ba0c8f", Component.options)
  }
