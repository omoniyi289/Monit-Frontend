...
var update = __webpack_require__(24)("1f8f6352", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_form__ = __webpack_require__(294);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_smoothscroll__ = __webpack_require__(295);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_src_validations_validations_js__ = __webpack_require__(296);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        register_user: function register_user() {
            ...
            if (this.formstate.$invalid) {} else {
                var user_details = {
                    user: this.model
                };
                ...
                axios.post(host_url + '/users', user_details).then(function (response) {
                    //console.log(response.data);
                    if (response.data.status == true) {
                        //this.model = {};
                        _this.success_message = "Thanks for registering with us, " + "an email has been sent to you, please verify your email. Thanks";
                        _this.submit_btn = "Sign up";
            ...
            "vue-form",
            {
              ...
              on: {
                submit: function($event) {
                  ...
                  return _vm.register_user($event)
                }
              }
            },
            [
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                [_vm._v("Fullname is a required field")]
                              )
                            ]
                          )
                        ],
