...
var update = __webpack_require__(24)("9ffaf826", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-616ed366\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./end-shift.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-616ed366\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./end-shift.vue");
      ...
      if (this.formstate2.$invalid) {
        ...
        axios.get(this.$store.state.host_url + "/pump-readings/by_station?" + params, {
          ...
          if (response.data.data.length == 0) {
            ...
            var _station_id = _this2.preset.station_id;

            axios.get(_this2.$store.state.host_url + "/pumps/by_station/" + _station_id, {
              headers: {
                "Authorization": "Bearer " + user_details.token, "Cache-Control": "no-cache"
              } }).then(function (response) {
              __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
              ...
              _this2.close_pump_reading.reading_date = _this2.set_date;
              _this2.station_pumps.forEach(function (element) {
                _this2.close_pump_reading.push({ 'pump_id': element.id,
                  'pump_nozzle_code': element.pump_nozzle_code, 'closing_reading': '', 'c_closing_reading': '',
                  'cash_collected': '', 'c_cash_collected': '', 'status': 'Shift End', 'reading_date': _this2.set_date });
              });
            }).catch(function (error) {
              __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
              __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("catch_errors", error);
      ...
      if (this.formstate.$invalid) {
        ...
        axios.patch(this.$store.state.host_url + "/pump-readings", { 'pumps': this.final_pump_info }, {
          ...
          if (error.response.status == 401) {
            _this3.$router.push('/login?message=' + error.response.data.error);
          }
          //console.log(error);
        });
      }
                ...
                [
                  _c(
                    ...
                    [
                      ...
                      _c("br"),
                      _vm._v(
                        "\n            Enter Readings for the " +
                          _vm._s(this.shift_batch) +
                          "\n            "
                      ),
                      _c("br"),
                      _vm._v(" "),
                                        ...
                                        _c("table", { staticClass: "table" }, [
                                          _c("thead", [
                                            _c("tr", [
                                              ...
                                              _c("th", [
                                                _vm._v(
                                                  "Confirm Closing Totalizer Reading"
                                                )
                                              ]),
                                              _vm._v(" "),
                                              _c("th", [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-616ed366", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/ss-management/end-shift.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-616ed366", Component.options)
  } else {
    hotAPI.reload("data-v-616ed366", Component.options)
  }
