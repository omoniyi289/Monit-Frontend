...
var update = __webpack_require__(24)("15ddd250", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-33399559\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./approve.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-33399559\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./approve.vue");
  ...
  methods: {
    ...
    onAction: function onAction(action, data, index) {
      ...
      if (action == 'update') {
        ...
        axios.get(this.url + '/verify_approval/details?' + request_detail, {
          ...
          _this2.pricing = data;
          _this2.approve = true;
          _this2.show_approval_pane = true;
          if (result.current_approval_level == 0) {
            _this2.is_level_one_approval = true;
            _this2.is_level_two_approval = false;
            _this2.is_level_three_approval = false;
          } else if (result.current_approval_level == 1) {
            _this2.is_level_one_approval = false;
            _this2.is_level_two_approval = true;
            _this2.is_level_three_approval = false;
          } else if (result.current_approval_level == 2) {
            _this2.is_level_one_approval = false;
            _this2.is_level_two_approval = false;
            _this2.is_level_three_approval = true;
          } else {
            ///an exception
            _this2.approve = false;
            _this2.show_approval_pane = false;
          }
    ...
    onSubmit: function onSubmit() {
      ...
      if (this.formstate.$invalid) {
        ...
        axios.post(__WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].state.host_url + '/fromMail_pricing', price_detail, {
          headers: {
            "Authorization": "Bearer " + user_details.token, "Cache-Control": "no-cache"
          }
        }).then(function (response) {
                                          ...
                                          _c(
                                            ...
                                            [
                                              _c(
                                                "label",
                                                {
                                                  attrs: { for: "is_approved" }
                                                },
                                                [
                                                  _vm._v(
                                                    "Approve/Disapprove (Level 1)"
                                                  )
                                                ]
                                              ),
                                              _vm._v(" "),
                                          ...
                                          _c(
                                            ...
                                            [
                                              _c(
                                                ...
                                                {
                                                  attrs: {
                                                    for: "is_approved_level"
                                                  }
                                                },
                                                [
                                                  _vm._v(
                                                    "Approve/Disapprove (Level 2)"
                                                  )
                                                ]
                                              ),
                                              _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-33399559", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/pricing/approve.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-33399559", Component.options)
  } else {
    hotAPI.reload("data-v-33399559", Component.options)
  }
