...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    show_station_transfers: function show_station_transfers(station_id, company_id) {
      var _this = this;
      ...
      if (this.formstate2.$invalid) {
        ...
        axios.get(this.$store.state.host_url + "/item-variants/stock-transfer/" + _station_id, {
          headers: {
          ...
          _this.tableData.forEach(function (element) {
            if (element.status == 'Discarded') {
              _this.$set(element, "status", "<span class='btn btn-danger btn-sm' >Discarded</span>");
              _this.$set(element, "__slot:actions", "");
            } else if (element.status == 'Completed') {
              _this.$set(element, "status", "<span class='btn btn-warning btn-sm' >Completed</span>");
            } else if (element.status == 'Received') {
              _this.$set(element, "status", "<span class='btn btn-success btn-sm' >Received</span>");
              _this.$set(element, "__slot:actions", "");
            }
          });
    ...
    onSubmit: function onSubmit() {
      ...
      if (this.formstate.$invalid) {
        ...
        axios.patch(__WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].state.host_url + '/item-variants/stock-transfer/' + this.item_variant.id, item_variant, {
          headers: {
            "Authorization": "Bearer " + user_details.token, "Cache-Control": "no-cache"
          }
        }).then(function (response) {
          ...
          _this2.tableData.forEach(function (element) {
            if (element.status == 'Discarded') {
              _this2.$set(element, "status", "<span class='btn btn-danger btn-sm' >Discarded</span>");
            } else if (element.status == 'Completed') {
              _this2.$set(element, "status", "<span class='btn btn-warning btn-sm' >Completed</span>");
            } else if (element.status == 'Received') {
              _this2.$set(element, "status", "<span class='btn btn-success btn-sm' >Received</span>");
            }
          });
        }).catch(function (error) {
          __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
                                    ...
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.item_variant.item.name,
                                        expression: "item_variant.item.name"
                                      }
                                    ],
                                ...
                                [
                                  ...
                                  _c(
                                      ...
                                      directives: [
                                        {
                                          name: "model",
                                          rawName: "v-model",
                                          value: _vm.item_variant.status,
                                          expression: "item_variant.status"
                                        }
                                      ],
                                      staticClass: "form-control",
                                      attrs: {
                                    ...
                                    [
                                      _c(
                                        "option",
                                        { attrs: { value: "Received" } },
                                        [_vm._v("Receive")]
                                      ),
                                      _vm._v(" "),
                                      _c(
                                        "option",
                                        { attrs: { value: "Discarded" } },
                                        [_vm._v("Discard")]
                                      )
                                    ]
                                  ),
                                    ...
                                    directives: [
                                      {
                                        ...
                                        rawName: "v-model",
                                        value:
                                          _vm.item_variant.quantity_transferred,
                                        expression:
                                          "item_variant.quantity_transferred"
                                      }
                                    ],
                                    staticClass: "form-control",
                                    attrs: {
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c(
                                        ...
                                        [_vm._v("Q T is a required field")]
                                      )
                                    ]
                                  )
                                ],
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _c("input", {
                                    directives: [
                                      {
                                        ...
                                        rawName: "v-model",
                                        value:
                                          _vm.item_variant.quantity_received,
                                        expression:
                                          "item_variant.quantity_received"
                                      }
                                    ],
                                    staticClass: "form-control",
                                    attrs: {
                                    ...
                                    domProps: {
                                      value: _vm.item_variant.quantity_received
                                    },
                                    on: {
                                      input: function($event) {
                                        if ($event.target.composing) {
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c(
                                        ...
                                        [_vm._v("Q R is a required field")]
                                      )
                                    ]
                                  )
                                ],
