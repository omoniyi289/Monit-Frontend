...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onSubmit: function onSubmit() {
      ...
      if (this.formstate.$invalid) {
        ...
        if (this.pricing.submit_mode == 'Add Price') {
          ...
          axios.post(this.url + '/new/', _price_detail, {
            headers: {
              "Authorization": "Bearer " + user_details.token
            }
          }).then(function (response) {
    ...
    get_pricing_approver: function get_pricing_approver() {
      var _this3 = this;

      __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("activateLoader", "start");
      ///get approvals
      var user_details = JSON.parse(localStorage.getItem('user_details'));
      var params = 'UI_slug=APCR&company_id=' + this.preset.company_id + '&station_id=' + this.preset.station_id;
      console.log(params);
                                      ...
                                      directives: [
                                        {
                                          name: "model",
                                          rawName: "v-model",
                                          value: _vm.pricing.approved_by,
                                          expression: "pricing.approved_by"
                                        }
                                      ],
                                      staticClass: "form-control",
                                      attrs: {
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c(
                                        ...
                                        [_vm._v("Price is a required field")]
                                      )
                                    ]
                                  )
                                ],
