...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vue_multiselect__ = __webpack_require__(522);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    show_company_roles: function show_company_roles(company_id) {
      ...
      axios.get(this.$store.state.host_url + "/roles/by_company/" + company_id, {
        ...
        _this2.tableData.forEach(function (item, index) {
          var perm = '';
          _this2.tableData[index]['selected_privileges'] = [];
          item.role_permissions.forEach(function (inner_item) {
            if (inner_item.permission !== undefined) {
              ...
              _this2.tableData[index]['selected_privileges'].push(element);

              _this2.tableData[index]['permissions'] = perm;
              _this2.tableData[index]['tabledata_index'] = index;
            }
          });
        });
      }).catch(function (error) {
    ...
    show_permissions: function show_permissions() {
      var _this3 = this;
