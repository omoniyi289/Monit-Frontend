...
var update = __webpack_require__(24)("695d82d2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5e2ca24b\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./open-station.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5e2ca24b\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./open-station.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_moment__ = __webpack_require__(298);
      ...
      if (this.formstate2.$invalid) {
        ...
        axios.get(this.$store.state.host_url + "/stock-readings/by_station?" + params, {
          ...
          if (response.data.data.length > 0) {
            ///station has data
            var last_transaction = response.data.data[0];
            ...
            _this2.set_date = __WEBPACK_IMPORTED_MODULE_7_moment___default()(d_date).format('YYYY-MM-DD HH:mm:ss');
          } else {
            ///new station
            var new_date = new Date();
            _this2.set_date = __WEBPACK_IMPORTED_MODULE_7_moment___default()(new_date.setDate(new_date.getDate() - 1)).format('YYYY-MM-DD HH:mm:ss');
            __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("showAlertBox", { 'alert_type': 'alert-warning',
          ...
          if (response.data.data.length > 0 && response.data.data[0].reading_date.includes(__WEBPACK_IMPORTED_MODULE_7_moment___default()(new Date()).format('YYYY-MM-DD'))) {
          ...
          _this2.show_setup_form = true;
          var params = 'station_id=' + _this2.preset.station_id + '&get_open_station_info=1';
          axios.get(_this2.$store.state.host_url + "/pump-readings/by_station?" + params, {
            headers: {
              "Authorization": "Bearer " + user_details.token, "Cache-Control": "no-cache"
            } }).then(function (response) {
            ...
            var params = 'station_id=' + _this2.preset.station_id + '&get_open_station_info=1';
            axios.get(_this2.$store.state.host_url + "/stock-readings/by_station?" + params, {
              headers: {
                "Authorization": "Bearer " + user_details.token, "Cache-Control": "no-cache"
              } }).then(function (response) {
              _this2.station_tanks = response.data.data;
              console.log(_this2.station_tanks);
              _this2.open_tank_reading = [];
              _this2.station_tanks.forEach(function (element) {
                _this2.open_tank_reading.push({ 'tank_code': element.code, 'tank_id': element.id, 'opening_reading': parseFloat(element.last_closing_reading), 'c_opening_reading': '',
    ...
    onSubmit: function onSubmit() {
      ...
      if (this.formstate.$invalid) {
        ...
        axios.post(this.$store.state.host_url + "/stock-readings", { 'stocks': this.final_stock_info }, {
          ...
          __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
          axios.post(_this3.$store.state.host_url + "/pump-readings", { 'pumps': _this3.final_pump_info }, {
            headers: {
              "Authorization": "Bearer " + user_details.token, "Cache-Control": "no-cache"
            }
          }).then(function (response) {
                  ...
                  _c(
                    ...
                    [
                      _c("div", [
                        ...
                        _c("i", [
                          _vm._v(
                            "Please note that opening readings are pre-loaded based on readings from the previous day and can be edited in case of mismatch"
                          )
                        ]),
                        _vm._v(" "),
                        _c("br")
                                        ...
                                        _c("table", { staticClass: "table" }, [
                                          _c("thead", [
                                            _c("tr", [
                                              ...
                                              _c("th", [
                                                _vm._v(
                                                  "Confirm Opening Volume Reading"
                                                )
                                              ])
                                            ])
                                          ]),
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  _vm
                                                                    ...
                                                                    .opening_reading,
                                                                expression:
                                                                  "open_tank_reading[index].opening_reading"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  _vm
                                                                    ...
                                                                    .c_opening_reading,
                                                                expression:
                                                                  "open_tank_reading[index].c_opening_reading"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                          ...
                                                          _c(
                                                            ...
                                                            [
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "Confirm Opening Reading is required"
                                                                  )
                                                                ]
                                                              ),
                                                              _vm._v(" "),
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "Opening and Confirm Opening Reading should match"
                                                                  )
                                                                ]
                                                              )
                                                            ]
                                        ...
                                        _c("table", { staticClass: "table" }, [
                                          _c("thead", [
                                            _c("tr", [
                                              ...
                                              _c("th", [
                                                _vm._v(
                                                  "Confirm Opening Totalizer Reading"
                                                )
                                              ])
                                            ])
                                          ]),
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  _vm
                                                                    ...
                                                                    .opening_reading,
                                                                expression:
                                                                  "open_pump_reading[index].opening_reading"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  _vm
                                                                    ...
                                                                    .c_opening_reading,
                                                                expression:
                                                                  "open_pump_reading[index].c_opening_reading"
                                                              }
                                                            ],
                                                            staticClass:
                                                              "form-control",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5e2ca24b", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/ss-management/open-station.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5e2ca24b", Component.options)
  } else {
    hotAPI.reload("data-v-5e2ca24b", Component.options)
  }
