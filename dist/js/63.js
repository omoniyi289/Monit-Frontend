...
var update = __webpack_require__(24)("6757f2e2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7d28b437\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./profile.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7d28b437\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./profile.vue");
...
// module
exports.push([module.i, "\n.dropzone_wrapper[data-v-7d28b437] {\n    width: 100%;\n}\n[data-v-7d28b437].quill-editor .ql-tooltip.ql-editing{\n    z-index:99;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_src_validations_validations_js__ = __webpack_require__(358);
//
//
//
//
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_2_vue_form___default.a, __WEBPACK_IMPORTED_MODULE_4_src_validations_validations_js__["a" /* default */]);
    ...
    methods: {
        onSubmit: function onSubmit() {
            ...
            if (this.formstate.$invalid) {
                ...
                axios.patch(__WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].state.host_url + url + this.model.id, user_detail, {
                    headers: {
                    ...
                    if (company_response.status === true) {
                        ...
                        if (_this.model.password !== undefined) {
                            password_message = ", password changed";
                        }
                        _this.$alert.success({ duration: 10000, forceRender: '',
                            message: 'Account Updated Successfully' + password_message, transition: '' });
                        ///finally

                        localStorage.setItem('user_details', JSON.stringify(_this.model));
                    }
        ...
        show_available_companies: function show_available_companies() {
            ...
            if (user_details.role_id == 'master' && user_details.company_id == 'master') {
                ...
                axios.get(__WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].state.host_url + company_route, {
                    ...
                    axios.get(_this2.$store.state.host_url + "/stations", {
                        headers: {
                            "Authorization": "Bearer " + user_details.token
                        } }).then(function (response) {
                        __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
                ...
                axios.get(__WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].state.host_url + company_route, {
                    ...
                    axios.get(_this2.$store.state.host_url + "/stations/by_user/" + user_details.id, {
                        ...
                        axios.get(_this2.$store.state.host_url + "/company_users/" + user_details.id, {
                            headers: {
                                "Authorization": "Bearer " + user_details.token
                            } }).then(function (response) {
                            _this2.myrole = response.data.data.role.name;
                        });
                    });
                }).catch(function (error) {
                    __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
        ...
        _c(
          ...
          [
            _c("div", { staticClass: "row" }, [
              _c(
                "div",
                { staticClass: "col-lg-4 col-4 mb-3" },
                [
              ...
              _c(
                "div",
                { staticClass: "col-lg-8 col-8 mb-3" },
                [
                  _c(
                    "vue-form",
                    {
                                ...
                                _c(
                                  ...
                                  [
                                    ...
                                    _c("input", {
                                      ...
                                      domProps: { value: _vm.model.fullname },
                                      on: {
                                        input: function($event) {
                                          if ($event.target.composing) {
                                            return
                                        ...
                                        _c(
                                          ...
                                          [
                                            ...
                                            _c(
                                              ...
                                              [
                                                _vm._v(
                                                  "New Password should be atmost 10 characters long"
                                                )
                                              ]
                                            )
                                          ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7d28b437", module.exports)
  }
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-7d28b437"
...
Component.options.__file = "src/components/pages/users/profile.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7d28b437", Component.options)
  } else {
    hotAPI.reload("data-v-7d28b437", Component.options)
  }
