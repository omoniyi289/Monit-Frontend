...
var update = __webpack_require__(24)("f9746c62", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-132d9a5e\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-132d9a5e\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(24)("c0f993ca", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-132d9a5e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./create.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-132d9a5e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./create.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    show_company_users: function show_company_users(company_id) {
      var _this = this;
    ...
    load_company_notifications: function load_company_notifications() {
      ...
      axios.get(this.$store.state.host_url + "/company_notifications?" + params, {
        ...
        response.data.data.forEach(function (item) {
          _this2.company_notifications.push(item.notification);
        });
      }).catch(function (error) {
        __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
        __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("catch_errors", error);
    ...
    deleteItem: function deleteItem(data) {
      ...
      axios.delete(this.url + '/' + data.id, {
        ...
        if (api_response.status === true) {
          _this4.tableData.splice(_this4.tableData.indexOf(data), 1);
        ...
        if (this.user.submit_mode == 'CREATE') {
          axios.post(this.url, user_detail, {
            ...
            if (api_response.status === true) {
              ...
              _this5.tableData.forEach(function (item, index) {
                var perm = '';
                _this5.tableData[index]['selected_stations'] = [];
                if (item.station_users !== undefined && item.station_users !== null) {
                  item.station_users.forEach(function (inner_item, inner_index) {
                    var element = '';
                    ...
                    if (inner_item.station !== undefined && inner_item.station !== null) {
                      element = inner_item.station;
                      perm = perm + "<span class='col-xs-4 btn btn-sm btn-success' style='margin-left:10px'>" + element.name + "</span>";
                      _this5.tableData[index]['selected_stations'].push(element);

                      _this5.tableData[index]['stations'] = perm;
                      _this5.tableData[index]['tabledata_index'] = index;
                    }
                  });
                }

                var notf = '';
                _this5.tableData[index]['selected_notifications'] = [];
                if (item.user_notifications !== undefined && item.user_notifications !== null) {
                  item.user_notifications.forEach(function (inner_item, inner_index) {
                    var element = '';
                    if (inner_item.module !== undefined && inner_item.module !== null) {
                      element = inner_item.module;
                      notf = notf + "<span class='col-xs-4 btn btn-sm btn-warning' style='margin-left:10px'>" + element.name + "</span>";
                      _this5.tableData[index]['selected_notifications'].push(element);

                      _this5.tableData[index]['notifications'] = notf;
                      _this5.tableData[index]['tabledata_index'] = index;
                    }
                  });
                }
              ...
              _this5.user = { submit_mode: "CREATE" };
            }
          }).catch(function (error) {
            __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
            __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("catch_errors", error);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-132d9a5e", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/users/create.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-132d9a5e", Component.options)
  } else {
    hotAPI.reload("data-v-132d9a5e", Component.options)
  }
