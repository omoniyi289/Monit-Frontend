...
var update = __webpack_require__(92)("bae72dde", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("289175e4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vue_multiselect__ = __webpack_require__(829);
    ...
    deleteItem: function deleteItem(data, url) {
      ...
      axios.delete(__WEBPACK_IMPORTED_MODULE_7_src_store_store_js__["a" /* default */].state.host_url + url + data.id, {
        ...
        if (company_response.status === true) {
          ...
          _this7.$alert.success({ duration: 5000, forceRender: '',
