...
var update = __webpack_require__(92)("d8757aa6", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_layouts_preloader_preloader__ = __webpack_require__(1868);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_layouts_right_side__ = __webpack_require__(1872);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_components_layouts_left_side_default_left_side__ = __webpack_require__(1877);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_components_layouts_header_fixed_header__ = __webpack_require__(1901);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_assets_sass_custom_scss__ = __webpack_require__(1909);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_components_layouts_css_fixed_menu_scss__ = __webpack_require__(1911);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("a92bd558", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("823b0846", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* template */
var __vue_template__ = __webpack_require__(1900)
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = injectStyle
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("2ba6387c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__menu__ = __webpack_require__(1881);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__left_profile_user_profile2_vue__ = __webpack_require__(1895);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        f_menu_items: function f_menu_items(r_p_array) {
            ...
            if (r_p_array == "all") {
                permissions = ["CMUs", "CMSt", "CMCo", "CMSt", "CPCR", "APCR", "CMRo", "APDS", "AExp", "SSCo", "MSCo", "CSSt", "MSSt", "AMPa", "AMEx", "RFSu", "AFRe", "PFRe", "RStk"];
            } else {
                ///company user
                //  var r_p_array = [];
            ...
            if (permissions.includes('CMCo') || permissions.includes('CMSt') || permissions.includes('CMRo') || permissions.includes('CMUs') || permissions.includes('APCR') || permissions.includes('CPCR')) {
...
exports.vmenu = __webpack_require__(1882);
exports.vsubMenu = __webpack_require__(1885);
exports.vmenuItem = __webpack_require__(1890);
...
/* template */
var __vue_template__ = __webpack_require__(1884)
/* template functional */
var __vue_template_functional__ = false
/* styles */
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("575b28d7", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("f5c0ea4e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("e03bb20e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
        ...
        _c("div", { staticClass: "col-12" }, [
          _c("div", { staticClass: "img-wrapper" }, [
            _c("img", {
              ...
              attrs: { src: __webpack_require__(1899), alt: "user" }
            })
          ]),
          _vm._v(" "),
    ...
    return _c("div", { staticClass: "leftuser_icons col-12 compact_data" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-md-3" }, [
          _c("a", { attrs: { href: "#/admin/users/profile", title: "" } }, [
...
module.exports = "/images/logo.jpg?49c051ea5456654d0caeb7c660f758c2";
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("007fb437", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("479704e2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_screenfull__ = __webpack_require__(1907);
    ...
    _c(
      ...
      [
        _c("router-link", { staticClass: "logo", attrs: { to: "/" } }, [
          _c("img", {
            attrs: { src: __webpack_require__(819), alt: "logo" }
          })
        ]),
        _vm._v(" "),
