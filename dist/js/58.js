...
var update = __webpack_require__(92)("6757f2e2", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_src_validations_validations_js__ = __webpack_require__(799);
//
//
//
//
            ...
            if (this.formstate.$invalid) {
                ...
                axios.patch(__WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].state.host_url + url + this.model.id, user_detail, {
                    ...
                    if (company_response.status === true) {
                        ...
                        _this.$alert.success({ duration: 5000, forceRender: '',
