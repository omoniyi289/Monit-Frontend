...
var update = __webpack_require__(24)("71d322ae", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-016e0580\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./setup.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-016e0580\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./setup.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_form__ = __webpack_require__(356);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_smoothscroll__ = __webpack_require__(357);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_components_plugins_DataTable_DataTable_vue__ = __webpack_require__(370);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_components_plugins_Company_Station_View_CSView_vue__ = __webpack_require__(375);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    name: "formfeatures",
    components: {
        datatable: __WEBPACK_IMPORTED_MODULE_4_components_plugins_DataTable_DataTable_vue___default.a, csview: __WEBPACK_IMPORTED_MODULE_5_components_plugins_Company_Station_View_CSView_vue___default.a
    },
    props: ['data'],
    data: function data() {
        return {
    ...
    methods: {
        show_available_companies: function show_available_companies() {
            ...
            if (__WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].state.show_single_company) {
                console.log(__WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].state.available_company);
                this.tableData.push(__WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].state.available_company);
            } else if (__WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].state.show_multi_company == true) {
                this.tableData = __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].state.available_companies;
            }
        },
        ...
        deleteItem: function deleteItem(data) {
            ...
            axios.delete(this.url + '/' + data.id, {
                ...
                if (company_response.status === true) {
                    _this2.tableData.splice(_this2.tableData.indexOf(data), 1);
                    _this2.$alert.success({ duration: 3000, forceRender: '',
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c(
                                        ...
                                        [
                                          _vm._v(
                                            "Company Email is a required field"
                                          )
                                        ]
                                      ),
                                      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-016e0580", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/company/setup.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-016e0580", Component.options)
  } else {
    hotAPI.reload("data-v-016e0580", Component.options)
  }
