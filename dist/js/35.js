...
var update = __webpack_require__(24)("028343a6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5c2e6f12\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./stock-transfer.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5c2e6f12\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./stock-transfer.vue");
      ...
      if (this.formstate2.$invalid) {
        ...
        axios.get(this.$store.state.host_url + "/pump-readings/by_station?" + params, {
          ...
          if (response.data.data.length == 0) {
            ...
            _this2.set_date = response.data.data[0].created_at;
            ...
            axios.get(_this2.$store.state.host_url + "/pumps/by_station/" + _station_id, {
              ...
              _this2.close_pump_reading.created_at = _this2.set_date;
              _this2.station_pumps.forEach(function (element) {
                _this2.close_pump_reading.push({ 'pump_id': element.id,
                  ...
                  'cash_collected': '', 'c_cash_collected': '', 'status': 'Shift End', 'created_at': _this2.set_date });
              });
            }).catch(function (error) {
              __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
              __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("catch_errors", error);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5c2e6f12", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/store-management/stock-transfer.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5c2e6f12", Component.options)
  } else {
    hotAPI.reload("data-v-5c2e6f12", Component.options)
  }
