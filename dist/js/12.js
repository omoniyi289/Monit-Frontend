...
var update = __webpack_require__(24)("d1aa254a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-de103af2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./receive-stock.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-de103af2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./receive-stock.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_moment__ = __webpack_require__(328);
      ...
      if (this.formstate2.$invalid) {
        ...
        axios.get(this.$store.state.host_url + "/stock-readings/by_station?" + params, {
          ...
          if (response.data.data.length > 0) {
            ...
            ///new station
            _this2.set_date = __WEBPACK_IMPORTED_MODULE_7_moment___default()(new Date()).format('YYYY-MM-DD HH:mm:ss');
          ...
          if (response.data.data[0].created_at.includes(__WEBPACK_IMPORTED_MODULE_7_moment___default()(new Date()).format('YYYY-MM-DD'))) {
            console.log(response.data.data[0].created_at);
            console.log(__WEBPACK_IMPORTED_MODULE_7_moment___default()(new Date()).format('YYYY-MM-DD'));
          ...
          _this2.show_setup_form = true;
          var station_id = _this2.preset.station_id;
          axios.get(_this2.$store.state.host_url + "/pumps/by_station/" + station_id, {
            headers: {
              "Authorization": "Bearer " + user_details.token
            } }).then(function (response) {
            __WEBPACK_IMPORTED_MODULE_6_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
            ...
            ///  }
            axios.get(_this2.$store.state.host_url + "/tanks/by_station/" + station_id, {
              headers: {
                "Authorization": "Bearer " + user_details.token
              } }).then(function (response) {
              ...
              _this2.station_tanks.forEach(function (element) {
                _this2.open_tank_reading.push({ 'tank_code': element.code, 'tank_id': element.id, 'opening_reading': '', 'c_opening_reading': '', 'status': 'Opened' });
              });
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-de103af2", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/store-management/receive-stock.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-de103af2", Component.options)
  } else {
    hotAPI.reload("data-v-de103af2", Component.options)
  }
