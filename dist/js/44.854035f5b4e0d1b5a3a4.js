...
var update = __webpack_require__(24)("17b122be", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-49d2bcee\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./setup.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-49d2bcee\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./setup.vue");
    ...
    onSubmit: function onSubmit() {
      ...
      if (this.formstate.$invalid) {
        ...
        if (this.pricing.submit_mode == 'Add Price') {
          ...
          axios.post(this.url, price_detail, {
            ...
            if (api_response.status === true) {
              ...
              for (var i = 0, len = _this2.products.length; i < len; i++) {
                if (_this2.products[i]['id'] === _this2.pricing.product_id) {
          ...
          axios.post(this.url + '/request/', _price_detail, {
            headers: {
              "Authorization": "Bearer " + user_details.token, "Cache-Control": "no-cache"
            }
          }).then(function (response) {
            ...
            var api_response = response.data;
            if (api_response.status === true) {
              _this2.log_tableData.push(response.data.data);

              _this2.log_tableData.forEach(function (element) {
                if (element.is_executed == 1) {
                  _this2.$set(element, "status", "<span class='btn btn-success btn-sm' >Executed</span>");
                } else if (element.is_approved_level_3 == 1) {
                  _this2.$set(element, "status", "<span class='btn btn-info btn-sm' >Approved- Level 3</span>");
                } else if (element.is_approved_level_3 == 0) {
                  _this2.$set(element, "status", "<span class='btn btn-danger btn-sm' >Disapproved- Level 3</span>");
                } else if (element.is_approved_level_2 == 1) {
                  _this2.$set(element, "status", "<span class='btn btn-info btn-sm' >Approved- Level 2</span>");
                } else if (element.is_approved_level_2 == 0) {
                  _this2.$set(element, "status", "<span class='btn btn-danger btn-sm' >Disapproved- Level 2</span>");
                } else if (element.is_approved == 1) {
                  _this2.$set(element, "status", "<span class='btn btn-info btn-sm' >Approved- Level 1</span>");
                } else if (element.is_approved == 0) {
                  _this2.$set(element, "status", "<span class='btn btn-danger btn-sm' >Disapproved- Level 1</span>");
                } else if (element.is_approved == null) {
                  _this2.$set(element, "status", "<span class='btn btn-warning btn-sm' >Not yet Approved</span>");
                }
              });
              ...
              _this2.pricing = { submit_mode: "Add Price" };
            }
          }).catch(function (error) {
            __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("activateLoader", "end");
            __WEBPACK_IMPORTED_MODULE_1_src_store_store_js__["a" /* default */].commit("catch_errors", error);
                      ...
                      directives: [
                        {
                          name: "show",
                          rawName: "v-show",
                          value: _vm.show_approval_pane && _vm.show_setup_form,
                          expression: "show_approval_pane && show_setup_form"
                        }
                      ],
                              ...
                              _c(
                                ...
                                [
                                  _c("input", {
                                    staticClass: "btn btn-success",
                                    attrs: { type: "submit" },
                                    domProps: { value: _vm.pricing.submit_mode }
                                  })
                                ]
                              )
                            ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-49d2bcee", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/pricing/setup.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-49d2bcee", Component.options)
  } else {
    hotAPI.reload("data-v-49d2bcee", Component.options)
  }
