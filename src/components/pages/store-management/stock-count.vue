                      ...
                      <b-tab title="" >
                            <table class="table">
                              ...
                              <tbody>
                                <tr  v-for="(option, index) in item_variants">
                                  ...
                                  <td>
                                    <validate tag="div">
                                      <input v-model="item_variants[index].qty_counted"  id="c_rd"  :name="c_cc+index" type="number" required placeholder="Quantity Counted" class="form-control" />
                            ...
                            <div class="col-sm-12">
                              <div class="form-group float-right">
                                <input type="submit" value="COMPLETE COUNT" class="btn btn-success"></input>
                              </div>
                            </div>
                        </b-tab>
                      </b-tabs>           
